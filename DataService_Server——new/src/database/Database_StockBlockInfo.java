...
public class Database_StockBlockInfo extends Database<StockBlockInfo> implements Datainterface<StockBlockInfo>{
	public Database_StockBlockInfo(){
		super();
		database.put("nanjing", new StockBlockInfo());
		database.put("shanghai", new StockBlockInfo());
		database.put("beijing", new StockBlockInfo());
		database.put("hangzhou", new StockBlockInfo());
	}
